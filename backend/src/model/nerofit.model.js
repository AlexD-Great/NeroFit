...
// Import the comprehensive schemas
const {
  User,
  UserStats,
  Challenge,
...
const UserChallengeProgressModel = mongoose.model(
  "UserChallengeProgress",
  userChallengeProgressSchema
);
const ActivityModel = mongoose.model("Activity", activitySchema);
const TokenTransactionModel = mongoose.model(
  "TokenTransaction",
...
// For backward compatibility, also export the main User model as the default
