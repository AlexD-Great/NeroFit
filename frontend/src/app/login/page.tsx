...
export default function LoginPage() {
  ...
  const { connectWallet, isLoading, error, isConnected } = useWallet();
        ...
        <div className="card">
          ...
          <div className="mb-6">
            ...
            <p className="text-xs text-white/60 mt-2 text-center">
              Recommended: Connect your wallet for the full Web3 experience
            </p>
          </div>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white/10 text-white/70 rounded">or continue with</span>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            >
              {isEmailLogin ? 'Hide email login' : 'Use email instead'}
            </button>
          </div>
